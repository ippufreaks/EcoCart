...
<body>
    <div class="failure-card d-block mx-auto my-5">
        ...
        <p>Unfortunately, your registration could not be completed. Please try again.</p>
        <p>Redirecting you to the <a href="../../login" target="_blank">registration page</a> in <span id="countdown" class="countdown">5</span> seconds...</p>
